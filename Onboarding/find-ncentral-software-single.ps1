...
$software = Get-InstalledSoftware -Name "Windows Agent"
if($software){$softwares += "   " + $software.name + ", "}
$software = Get-InstalledSoftware -Name "Windows Software Probe"
if($software){$softwares += "   " +  $software.name + ", "}
$software = Get-InstalledSoftware -Name "Request Handler Agent"
if($software){$softwares += "   " +  $software.name + ", "}
$software = Get-InstalledSoftware -Name "Patch Management Service Controller"
if($software){$softwares += "   " +  $software.name + ", "}
$software = Get-InstalledSoftware -Name "File Cache Service Agent"
if($software){$softwares += "   " +  $software.name + ", "}
$software = Get-InstalledSoftware -Name "Ecosystem Agent"
if($software){$softwares += "   " +  $software.name + ", "}
...
write-host $env:COMPUTERNAME -ForegroundColor $display
$softwares
