#$Hashtable = @{}
$RegistryValue = Get-ItemProperty 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU\'
...
$mystream = [IO.MemoryStream]::new([byte[]][char[]]$RegistryValue.ToString())
...
$RegistryValue = Get-ItemProperty 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\'

Get-Hash -text $RegistryValue -algorithm "SHA-256"
