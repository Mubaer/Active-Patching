...
$KT = 'KT113216'
$KN = 'BOSCOR'
$icssatellite = '192.168.250.236'

param (
[Parameter(Mandatory=$true)][String]$KT,
[Parameter(Mandatory=$true)][String]$KN,
[Parameter(Mandatory=$true)][String]$icssatellite
)
...
#$onboarders = @('w2k12-av-wsus')
$onboarders = $(Get-WsusComputer).FullDomainName
...
$insertcontent2 ="<table>" + "<h1>Patchmanagement: Postflightcheck fuer Kunde " + $KN + "</h1><p Style = `"font-family: 'Quicksand', sans-serif; font-weight: 500; font-size: 14px;`"> (Kundennummer: " + $KT + ")<br /> Erzeugt am: " + $(get-date -Format "dd.MM.yyyy hh:mm:ss") + "<br /> Version: " + $version
